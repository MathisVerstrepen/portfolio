export const tech_fr = {
    "tech.title": "Technologies maîtrisées",
    "tech.categories": [
        "web", "database", "general", "devops", "other"
    ]
}

export const tech_web_fr = {
    "tech.web.title": "Développement web",
    "tech.web.number": 9,
...
export const tech_database_fr = {
    "tech.database.title": "Database",
    "tech.database.number": 4,
...
export const tech_general_fr = {
    "tech.general.title": "Langages généraux",
    "tech.general.number": 3,
...
export const tech_devops_fr = {
    "tech.devops.title": "Outils DevOps",
    "tech.devops.number": 4,
...
export const tech_other_fr = {
    "tech.other.title": "Autres",
    "tech.other.number": 4,
